...
const AuthenticationRefreshUseCase = require('../AuthenticationRefreshUseCase')

describe('AuthenticationRefreshUseCase', () => {
  it('should throw error if use case payload not contain refresh token', async () => {
    // Arrange
    const useCasePayload = {}
    const authenticationRefreshUseCase = new AuthenticationRefreshUseCase({})

    // Action & Assert
    await expect(
      authenticationRefreshUseCase.execute(useCasePayload)
  ...
  it('should orchestrating the refresh authentication action correctly', async () => {
    ...
    // Action
    const accessToken =
      await authenticationRefreshUseCase.execute(useCasePayload)
