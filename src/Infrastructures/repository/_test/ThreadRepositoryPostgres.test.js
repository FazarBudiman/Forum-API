...
describe('ThreadRepositoryPostgres', () => {
    ...
    describe('addThread function', () => {
        it('should persist post thread and return posted thread correctly', async  () => { 
            ...
            await UsersTableTestHelper.addUser({ id: idUser, username: 'dicoding', password: 'secret', fullname:'Dicoding Indonesia' }); 
    ...
    describe('checkThreadIsExist function', () => {
        it('should throw NotFoundError when threads not exist', async () => {
            ...
            // Action and Assert
            await expect(threadRepositoryPostgres.checkThreadIsExist('thread-12345')).rejects.toThrowError(NotFoundError)
        ...
        it('should not throw NotFoundError when threads exist', async () => {
             ...
             await UsersTableTestHelper.addUser({ id: 'user-123', username: 'dicoding', password: 'secret', fullname:'Dicoding Indonesia' }); 
                // Add Thread
             await ThreadsTableTestHelper.addThread({id: 'thread-12345', owner: 'user-123'})
             const threadRepositoryPostgres = new ThreadRepositoryPostgres(pool, {})
